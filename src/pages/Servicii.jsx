...
export default function Servicii() {
    return (
        <div
            className="min-h-screen flex flex-col items-center pt-32 px-4 bg-cover bg-center"
            style={{ backgroundImage: "url('/images/home-backgr.png')" }}
        >
            <div
                className="
          bg-white/10 border border-white/20 rounded-3xl shadow-xl
          p-8 md:p-12 w-full max-w-5xl text-white
        "
            >
                ...
                <p className="text-center max-w-2xl mx-auto text-white/85 mb-10 text-lg md:text-xl leading-relaxed">
                    Oferim o gamă completă de servicii notariale, cu profesionalism,
                ...
                <div className="flex flex-wrap justify-center gap-6">
                    {services.map((service) => (
                        <Link
                            ...
                            to={service.path}
                            className="
                w-40 h-40 md:w-48 md:h-48 rounded-2xl bg-white/20
